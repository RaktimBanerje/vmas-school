...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2024 at 02:26 PM
...
INSERT INTO `discounts` (`id`, `student_id`, `amount`, `type`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 10.00, 'percentage', 1, '2024-03-31 07:45:32', '2024-03-31 02:41:01'),
(2, 2, 10.00, 'fixed', 1, '2024-03-31 07:45:40', '2024-03-31 02:45:02');
...
CREATE TABLE `fees` (
  ...
  `discount_amount` float(11,2) DEFAULT 0.00,
  `discount_type` varchar(255) DEFAULT NULL,
  `cash_amount` float(11,2) DEFAULT NULL,
  `return_amount` float(11,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `fees` (`id`, `student_id`, `total_amount`, `payment_amount`, `payment_for`, `payment_mode`, `payment_date`, `from_date`, `to_date`, `discount_applied`, `discount_amount`, `discount_type`, `cash_amount`, `return_amount`, `created_at`, `updated_at`) VALUES
(6, 2, 50.00, 50.00, 'admission', 'offline', '2024-03-13', NULL, NULL, 0, 0.00, NULL, NULL, NULL, '2024-03-13 07:17:59', '2024-03-13 07:17:59'),
(7, 2, 2400.00, 2400.00, 'monthly', 'offline', '2024-03-01', '2024-03-01', '2024-03-31', 0, 0.00, NULL, NULL, NULL, '2024-03-13 07:17:59', '2024-03-13 07:17:59'),
(16, 2, 2400.00, 2390.00, 'monthly', 'offline', '2024-03-31', '2024-04-01', '2024-05-31', 1, 10.00, 'fixed', 2390.00, 0.00, '2024-03-31 06:54:30', '2024-03-31 06:54:30');
...
(16, '2024_03_30_175150_create_discounts_table', 5);
...
(2, 1, 1, 2, '2024-03-18', '2024-03-13 11:31:46', '2024-03-13 11:31:46');
...
(2, 2, 'public/images/nfiQHhyDaFvmslnE2ZQTiGfKcdeoXj4syoeuy7h9.jpg', '1710334079', 'asd', 'Sumit Sahoo', 'asd', 'asd', 'asd', 'asd', 'asd', 'male', '2024-03-22', NULL, '2024-03-13 07:17:59', '2024-03-13 07:17:59');
